...
test_that("extraction is robust to double spaces", {
  ...
  expect_equal(extract_alleles_df(df_in, "typing", locus = "A"), df_out)
})
...
test_that("extraction is robust to trailing spaces", {
  ...
  df_out["typing"] <- stringr::str_squish(df_out["typing"])
  expect_equal(extract_alleles_df(df_in, "typing", locus = "C"), df_out)
})
...
test_that("public is ignored", {
  ...
  expect_equal(extract_alleles_df(df_in, "typing", locus = "B"), df_out)
})
...
test_that("both HLA-DPB1 alleles are extracted from beginning", {
  ...
  expect_equal(extract_alleles_df(df_in, "typing", locus = "DPB1"), df_out)
})
...
test_that("both HLA-DQA1 alleles are extracted from beginning", {
  ...
  expect_equal(extract_alleles_df(df_in, "typing", locus = "DQA1"), df_out)
})
...
test_that("both HLA-DQB1 alleles are extracted from beginning", {
  ...
  expect_equal(extract_alleles_df(df_in, "typing", locus = "DQB1"), df_out)
})
...
test_that("both HLA-DRB1 alleles are extracted from beginning", {
  ...
  expect_equal(extract_alleles_df(df_in, "typing", locus = "DRB1"), df_out)
})
...
test_that("all variants are extracted", {
  ...
  expect_equal(extract_alleles_df(df_in, "typing", locus = "DRB."), df_out)
